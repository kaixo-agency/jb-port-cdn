...
$(document).ready(function () {
    var words = ["Graphic Designer","Graphic Designer", "Web Designer", "UI Designer", "Art Director", "Illustrator", "Multidisciplinary Designer"];
    var index = 0;
    var typingSpeed = 100;
...
if (aboutSection) {
    const observer = new IntersectionObserver((entries, observer) => {
        ...
        rootMargin: '-2% 0px -5% 0px' // Add a margin to trigger when the section is about to enter/exit
    });
